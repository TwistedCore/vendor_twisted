...
ifeq (linux,$(HOST_OS))
  ...
  $(info Clang version for build.prop: '$(AND_CLANG_VERSION)')
  ...
  ifeq (arm,$(TARGET_ARCH))
    ...
    $(info GCC version for build.prop: '$(ARM_AND_PROP)')
    ...
    ADDITIONAL_BUILD_PROPERTIES += \
      ro.build.kernel=$(ARM_KERNEL_PROP)
    $(info GCC version for build.prop: '$(ARM_KERNEL_PROP)')
    ...
    ADDITIONAL_BUILD_PROPERTIES += \
      ro.build.gcc=$(AARCH64_AND_PROP)
    $(info GCC version for build.prop: '$(AARCH64_AND_PROP)')
  endif
endif
